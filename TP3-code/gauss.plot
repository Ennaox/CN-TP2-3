...
set output "image/err_av_gausskij.png"
...
plot "data/gausskij.dat" using 4:1 t "Erreur Avant gausskij" w lp;
...
plot "data/gausskij.dat" using 4:2 t "Erreur Arrière gausskij" w lp;
